...
const seedProductionProducts = async () => {
  try {
    // Use production MongoDB URI from environment or fallback toRender service
    ...
    console.log(`✅ Successfully seeded ${inserted.length} products to production database!`)
    
    // Log the inserted products for verification
